	...
	<view style="background-color: #FFFFFF;height: 100vh;">
		<view class="u-page">
			...
			<view style="background-color: #0AAC61;height: 50vh;width: 100vw;position: fixed;text-align: center;">
				...
				<view
					style="position: relative;top: 50upx;color: #FFFFFF;font-size:16px;font-family:PingFang SC;font-weight:bold;line-height:22px;">
					{{name}}
				</view>
			</view>
			
			<view class=""
				style="width:100vw;height:55.5vh;background-color: #FFFFFF;border-radius: 18px 18px 0 0;position: absolute;top: 550upx;">
